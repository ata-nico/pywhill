...
# --- 設定 ---
VIDEO_PATH     = r"C:\Users\ata3357\Desktop\zemi_win\CR-chair\pywhill\my_research\distribute\video\test_movie.mp4"
...
# --- フレーム保存用ディレクトリ ---
SAVE_DIR = r"C:\Users\ata3357\Desktop\zemi_win\CR-chair\pywhill\my_research\distribute\frames\RSS"
...
while True:
    ...
    save_name = os.path.join(
        SAVE_DIR,
        f"frame_{frame_idx:06d}_{direction}_rss{int(rss)}.png"
    )
...
print(f"Average FPS      : {avg_fps:.2f}   (inference+RSS only)")
