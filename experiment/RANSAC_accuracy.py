...
INLIER_RATIO_TH  = 0.54

# --- フレーム保存用ディレクトリ ---
SAVE_DIR = r"C:\Users\ata3357\Desktop\zemi_win\CR-chair\pywhill\my_research\distribute\frame\ransac"
...
while True:
    ...
    save_fname = os.path.join(
        SAVE_DIR,
        f"frame_{frame_idx:06d}_{direction}.png"
    )
