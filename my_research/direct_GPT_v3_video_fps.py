...
MODEL_PATH        = r"C:\Users\ata3357\Desktop\zemi_win\block_result\rans5\weights\best.pt"
ROI_ANGLE_DEG     = 60
FOV_DEG           = 360
CONF_THRESH       = 0.2
...
# --- 切り替えフラグ ---
SAVE_FRAMES = False   # True にするとフレームPNGも保存
# --- 準備 ---
...
while True:
    ...
    out.write(frame)
    if SAVE_FRAMES:
        fname = f"frame_{frame_idx:06d}_{direction}.png"
        cv2.imwrite(os.path.join(FRAME_SAVE_DIR, fname), frame)
